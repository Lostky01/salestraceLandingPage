...
@section('konten')
    <section class="desktop-show">
        <section class="atas" style="padding:10%">
            <div class="col-lg-12">
                <center>
                    <h1 style="color: #FFF;font-size: 45px;font-weight: 700;">Paket harga fleksibel untuk <br> memenuhi
                        kebutuhan
                        bisnis Anda</h1>
                </center>
            </div>
            <div class="col-lg-12">
                <center>
                    <p style="color: #FFF;font-size: 22px;font-weight: 400;">Dengan Berlangganan Platform Omsetku, Anda dapat
                        mengakses platform lengkap kami <br> dan memanfaatkan harga per jam yang mudah dipahami dan
                        disesuaikan
        ...
        <section class="cards">
            ...
            <center>
                <p style="color: #000;font-size: 18px;font-weight: 400;">Kami menggabungkan observabilitas mendalam, AIOps,
                    dan
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6" style="padding:5px">
                                        <p
                                            ...
                                            Rp. 2.500.000</p>
                                        <p style="color: #909799;font-size: 11px;font-weight: 400;text-align: right;">Per
                                            user,
                                            per month <br>
                                            paid annually</p>
                                    </div>
                                    <p style="color: #3C3F40;font-size: 15px;font-weight: 400;">Paket dasar kami dengan
                                        Google
                        ...
                        <div class="card"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <p style="color: #3C3F40;font-size: 15px;font-weight: 400;">Rencana pertumbuhan kami
                                        yang
                                        paling <br>
                                ...
                                <div class="col-12 justify-content-center">
                                    ...
                                    <ul class="list-group list-group-flush mt-5" style="background-color:#F4F9FA;">
                                        ...
                                        <li class="list-group-item mt-3" style="background-color:#F4F9FA;">Everything in
                                            Basic,
                                            plus:
                        ...
                        <div class="card" style="width: 100%;height:100%;box-shadow: 0 8px 8px rgba(48, 47, 47, 0.1);">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <p style="color: #3C3F40;font-size: 15px;font-weight: 400;">Jika Anda fokus pada
                                        penskalaan,
                                        gunakan <br>
        ...
        <section class="omsetku digital">
            <div class="row">
                <div class="col-lg-6 digitalspecial" style="padding:10%">
                    ...
                    <p style="color: #000;font-size: 18px;font-weight: 400;">We earn the trust of our customers, employees,
                        and
                        <br> extended family through transparency, security, compliance, <br> privacy, and performance. And
                        we
        ...
        <section class="membantu pelanggan sukses">
            <center>
                <h1 style="color: #000;font-size: 40px;font-weight: 700;">Membantu pelanggan sukses. Itu urusan Omsetku.
                </h1>
            </center>
            <center>
                <p style="color: #000;font-size: 18px;font-weight: 400;">Para pendiri kami meluncurkan model 1-1-1, yang
                    ...
                    kesetaraan, dan lingkungan bagi semua orang. Saat ini, <br> lebih dari 17.000 perusahaan di seluruh
                    dunia
                    telah bergabung dengan kami dalam gerakan Pledge 1%.</p>
            </center>
            <div class="row">
                <div class="col-lg-6" style="padding:5%">
                    <section class="imgsukses w-100 h-100">
                        <img src="{{ asset('price-asset/orangsukses.png') }}" alt="">
                    </section>
                    <section class="imgsukses2 w-100 h-100">
                        <img class="imgsukses2" src="{{ asset('price-asset/orangsukses2.png') }}" style="width: 600px"
                            alt="">
                    </section>
                </div>
                <div class="col-lg-6" style="padding-top:10%">
                    ...
                    <p style="color: #000;font-size: 18px;font-weight: 400;">Selain Anda akan mendapat keuntungan sebagai
                        ...
                        potongan
                        Rp 250.000 <br> untuk paket langganan pertama mereka.
                    </p>
                </div>
            </div>
        </section>
        <section class="value omsetku">
            ...
            <div class="row justify-content-center" style="padding:5%">
                <div class="col-3">
                    ...
                    <center>
                        <p style="color: #000;font-size: 17px;font-weight: 400;">Tim support yang responsif & selalu <br>
                            siap
                ...
                <div class="col-3">
                    ...
                    <center>
                        <p style="color: #000;font-size: 17px;font-weight: 400;">Implementasi dan pelatihan <br> produk
                            oleh
                ...
                <div class="col-3">
                    ...
                    <center>
                        <p style="color: #000;font-size: 17px;font-weight: 400;">Konsultasi solusi bisnis secara <br>
                            personal
                ...
                <div class="col-3">
                    ...
                    <center>
                        <p style="color: #000;font-size: 17px;font-weight: 400;">Panduan produk Goodeva <br> yang lengkap
                            dan
        ...
        <section class="fitur unggulan omsetku">
            ...
            <center>
                <p style="color: #000;font-size: 18px;font-weight: 400;">Nilai-nilai inti kita memandu segala sesuatu yang
                    kita
                    lakukan sebagai perusahaan dan sebagai <br> manusia. Kami berusaha untuk memberikan yang terbaik dari
                    satu
            ...
            <div class="row">
                <div class="col-lg-6 detailspecial" style="padding-top:15%;padding-left:15%">
                    ...
                    <p style="color: #000;font-size: 18px;font-weight: 400;">So we champion them to achieve extraordinary
                        things. We <br> innovate and expand our business offerings to provide all <br> our stakeholders with
                        new
            ...
            <div class="row">
                ...
                <div class="col-lg-6" style="padding-top:10%">
                    ...
                    <h2 style="color: #1E3168;font-weight: 700;font-size: 30px;">Tingkatkan kinerja sales dengan komisi
                    </h2>
            ...
            <div class="row">
                <div class="col-lg-6 expensespecial" style="padding-top:15%;padding-left:15%">
                    <h1 style="color: #1E3168;font-size: 40px;font-weight: 700;">Expense</h1>
                    <h2 style="color: #1E3168;font-weight: 700;font-size: 30px;">Pantau dan hitung semua pengeluaran
                        anti
                        salah</h2>
