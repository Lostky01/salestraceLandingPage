...
<section id="features" class="features bg-white menu-1 desktop-show">
  ...
  <div class="container">
    ...
    <div class="col-lg-12 row order-1 order-md-2 features-img-content">
      <img src="omsetku-asset/omsetku-sisales.png" class="img-when" alt="">
      <div class="col-lg-3">
        <img src="omsetku-asset/omsetku-matahari.png" class="img-when" alt="">
      </div>
    </div>
    <div class="row gy-4 align-items-center features-item " data-aos="fade-up">
