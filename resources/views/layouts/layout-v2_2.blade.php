...
<body>
    <!-- ======= Header ======= -->
    <header id="header" class="header d-flex fixed-top desktop-show">
        <div class="d-flex" style="padding-left:5%">
            <ul class="">
                @if (request()->is('contactus'))
                    <li>
                        <a href="{{ url('/') }}" class="logo d-flex align-items-center">
                            <img class="logo" src="{{ asset('logoomsetku2.png') }}" alt="">
                        </a>
                    </li>
                @else
                    <li>
                        <a href="{{ url('/') }}" class="logo d-flex align-items-center">
                            <img class="logo" src="{{ $baseurl }}public/assets/img/logo omsetku rev.png"
                                alt="">
                        </a>
                    </li>
                @endif
            ...
            <nav id="navbar" class="navbar justify-content-start">
                <ul class="list-menu justify-content-start">
                    @if (request()->is('contactus'))
                        <li name-class="heros">
                            <a href="" style="color: #1E3060; font-size: 14px; font-weight: 600;"
                                class="heros">Mengapa Omsetku</a>
                        </li>
                        <li name-class="features" class="px-vw1">
                            <a href="" style="color: #1E3060; font-size: 14px; font-weight: 600;"
                                class="features">Partnership</a>
                        </li>
                        <li name-class="features" class="pr-vw4">
                            <a href="" style="color: #1E3060; font-size: 14px; font-weight: 600;"
                                class="features">Price</a>
                        </li>
                        <li name-class="features" class="pr-vw4">
                            <a href="" style="color: #1E3060; font-size: 14px; font-weight: 600;"
            ...
            <a href="" class="service-details btn btn-primary"></a>
          </li>
          <li name-class="btn-coba">
            <a href="" class="nav-button-img btn btn-primary"></a>
          </li> --}}
                    @else
                        <li name-class="heros">
                            <a href="" class="heros">Mengapa Omsetku</a>
                        </li>
                        <li name-class="features" class="px-vw1">
                            <a href="" class="features">Partnership</a>
                        </li>
                        <li name-class="features" class="pr-vw4">
                            <a href="" class="features">Harga</a>
                        </li>
                        <li name-class="btn-banner" class="pr-vw1">
                            <a href="" class="service-details btn btn-primary"></a>
                        </li>
                ...
                <div class="col-lg-6 col-xl-6">
                    <div class="row">
                        <div class="col-lg-12 footer-describe">
                            <a href="{{ url('/') }}">
                                <img src="{{ $baseurl }}public/assets/img/logo omsetku rev.png" alt=""
                                    class="footer-logo">
                            </a>
                            <p>Sales Software berbasis aplikasi yang membuat aktivitas penjualan jadi lebih mudah
                                semudah pesan ojek online.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xl-6 footer-info">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <p>
                                <a href="https://www.instagram.com/omsetku/" target="_blank"><i
                                        class="bi bi-instagram"></i></a>
                                <a href="https://www.facebook.com/Omsetku-100543845527563/" target="_blank"><i
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <a href="https://play.google.com/store/search?q=omsetku&c=apps" target="_blank">
                                <img src="{{ $baseurl }}public/assets/img/googleplay.png" alt=""
                                    class="btn-footer">
                            </a>
                        </div>
                    </div>
    ...
    <!-- Chat Whatsapp -->
    <a href="//wa.me/+628818850663" class="back-to-top d-flex align-items-center justify-content-center"><i
