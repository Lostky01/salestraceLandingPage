  ...
  <div class="d-flex" style="padding-left:5%">
    ...
    <nav id="navbar" class="navbar justify-content-start">
      <ul class="list-menu justify-content-start">
        @if(request()->is('contactus'))
          <li name-class="heros">
            <a href="" style="color: #1E3060; font-size: 14px; font-weight: 600;" class="heros">Mengapa Omsetku</a>
          </li>
          <li name-class="features" class="px-vw1">
            <a href="" style="color: #1E3060; font-size: 14px; font-weight: 600;" class="features">Partnership</a>
          </li>
          <li name-class="features" class="pr-vw4">
            <a href="" style="color: #1E3060; font-size: 14px; font-weight: 600;" class="features">Price</a>
          </li>
          <li name-class="features" class="pr-vw4">
            <a href="" style="color: #1E3060; font-size: 14px; font-weight: 600;" class="features">Features</a>
          </li>
        ...
        <div class="col-lg-6 col-xl-6">
          <div class="row">
            <div class="col-lg-12 footer-describe">
              <a href="{{ url('/') }}">
                <img src="{{ $baseurl }}public/assets/img/logo omsetku rev.png" alt="" class="footer-logo">
              </a>
          ...
          <div class="row">
            <div class="col-lg-6">
              <a href="https://play.google.com/store/search?q=omsetku&c=apps" target="_blank">
                <img src="{{ $baseurl }}public/assets/img/googleplay.png" alt="" class="btn-footer">
              </a>
            </div>
          </div>
        </div>
